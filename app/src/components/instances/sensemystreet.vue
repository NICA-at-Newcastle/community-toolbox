<template lang="pug">
  #home
    ...
    collaborate(align="left" id="w-propose-workshop" title="Propose a new community idea" subtitle="Write a short description of your proposed idea and post it on the site."  v-bind:styles="{ 'background-color': '#fff'}" theme="dark" imageSrc="/static/images/illustrations/comtech/idea2.svg" )
    collaborate(align="right" id="w-collaborate" title="Collaborate" subtitle="Share your idea with the wider community and invite others to help you shape the idea." imageSrc="/static/images/illustrations/comtech/share2.svg")
    collaborate(align="left" id="w-design" title="Design together" subtitle="Use the online space to form thoughts, ask questions and make decisions about the idea." v-bind:styles="{ 'background-color': '#fff'}" theme="dark" imageSrc="/static/images/illustrations/comtech/design2.svg" action="Learn More" link="/learn")
    collaborate(align="right" title="Lend Sensors" subtitle="Sign Up to do borrow sensors from the community toolbox to explore your idea." action="Sign Up" imageSrc="/static/images/illustrations/sms/sensor.svg" clickaction="true" link="https://goo.gl/forms/7A9eVtB4KwyuM0AA2")
    featured-ideas
