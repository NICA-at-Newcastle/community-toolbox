<template lang="pug">
  #home
    ...
    collaborate(align="right" title="Borrow Sensors" subtitle="Fill in the form to borrow sensors from the community toolbox." action="Get a Sensor" v-bind:styles="{ 'background-color': '#fff'}" theme="dark" imageSrc="/static/images/illustrations/sms/sensor.svg" clickaction="true" link="https://goo.gl/forms/7A9eVtB4KwyuM0AA2")    
    collaborate(align="left" id="w-propose-workshop" title="Propose a new community idea" subtitle="Write a short description of your proposed idea and post it on the site." imageSrc="/static/images/illustrations/comtech/idea2.svg")
