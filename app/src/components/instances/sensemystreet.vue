<template lang="pug">
  #home
    ...
    collaborate(align="right" title="Borrow Sensors" subtitle="Sign Up to borrow sensors from the community toolbox." action="Get a Sensor" v-bind:styles="{ 'background-color': '#fff'}" theme="dark" imageSrc="/static/images/illustrations/sms/sensor.svg" link="/toolbox")    
