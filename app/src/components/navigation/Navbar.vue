  ...
  #navbar(v-bind:class="[{ scrolled: hasScrolled }, authState]" v-bind:style="[instanceBackground]")
    .row
      ...
      #menu(v-bind:class="{ active: active }" v-bind:style="[instanceBackground]")
        router-link(v-bind:to="{ name: 'start' }"  v-if="isAdmin || isModerator" v-bind:style="{color: instanceLogoColor}" ) Create (admin)
        ...
        router-link(v-bind:to="{ name: 'explore' }" v-bind:style="{color: instanceLogoColor}") Tasks and Challenges
        router-link(v-bind:to="{ name: 'faq' }" v-bind:style="{color: instanceLogoColor}") FAQ
